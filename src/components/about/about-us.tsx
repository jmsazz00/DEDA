        ...
        <div className="about__display">
          <div className="about-block">
            <header className="block__header about__header">
              <h1
                className="block__heading about__heading"
                data-aos="fade-down"
              >
            ...
            <div className="about__body">
              <p className="about__text" data-aos="fade-left">
                ...
                empowering Lebanese youth by providing free training sessions.
                Our goal is to equip them with the skills needed to respond to
                the needs of industrialists and employers, ultimately helping
            ...
            <div className="about__body">
              <ul className="goals-list">
                <li data-aos="fade-left">
                  ...
                  <b>Free</b> trainings for Lebanese youth, in order to be able
                  to secure their future.
                </li>
                <li data-aos="fade-right">
                  <span className="checkmark">✓</span>
                  Full <b>cooperation</b> with employers to determine their
                  needs and develop the training courses’ curricula accordingly.
                </li>
                <li data-aos="fade-left">
                  <span className="checkmark">✓</span>
                  <b>Compentent</b> trainers who are known for their knowledge
                  and practical experience.
                </li>
                <li data-aos="fade-right">
                  <span className="checkmark">✓</span>
                  <b>Life</b> skills, work organization, personal and public
                  safety, providing first aids in addition to the purely
                  technical topics.
                </li>
                <li>
                  <span className="checkmark">✓</span>
